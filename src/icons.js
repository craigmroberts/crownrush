...
export const ICONS = {
  ...
  iron: `<rect x="3" y="6" width="18" height="14" rx="1.5" fill="#59636e" ${S}/><path d="M9 6v14M15 6v14" stroke="#9fb0bd" stroke-width="1.4"/><circle cx="6" cy="9" r="1" fill="#c7d2dc"/><circle cx="12" cy="9" r="1" fill="#c7d2dc"/><circle cx="18" cy="9" r="1" fill="#c7d2dc"/><circle cx="6" cy="17" r="1" fill="#c7d2dc"/><circle cx="12" cy="17" r="1" fill="#c7d2dc"/><circle cx="18" cy="17" r="1" fill="#c7d2dc"/>`,
