...
export const ICONS = {
  ...
  heart: `<path d="M12 20.4l-1.5-1.3C5.6 14.7 3 12.3 3 9.2 3 6.7 5 4.7 7.5 4.7c1.5 0 2.9.7 3.8 1.8l.7.9.7-.9c.9-1.1 2.3-1.8 3.8-1.8C19 4.7 21 6.7 21 9.2c0 3.1-2.6 5.5-7.5 9.9z" fill="#ff5a4a" ${S}/><path d="M7.7 7c-1 0-1.9.8-1.9 1.9 0 .5.1 1 .4 1.4" fill="none" stroke="#ff9a8f" stroke-width="1.8" stroke-linecap="round"/>`,
