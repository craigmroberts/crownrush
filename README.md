...
and `castles-do-not-leak` hold it — twenty-five castles in a row hold geometries at about 200 (195 to 194
in the last run) and textures at 36 between castle 5 and castle 25, with no castle above 225 draw calls
-- a boss castle among them since R5; the same run with a teardown
